(function(module) {
	...
	Theme.init = function(params, callback) {
		...
		params.app.get('/readmore', params.middleware.buildHeader, renderReadMore);
		params.app.get('/templates/readmore.tpl', renderReadMore);
		params.app.get('/api/readmore', renderReadMore);

		params.app.get('/download', params.middleware.buildHeader, renderDownload);
		params.app.get('/templates/download.tpl', renderDownload);
		params.app.get('/api/download', renderDownload);
